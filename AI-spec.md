# AI SPEC — Trợ lý đối chiếu thông tin tuyển sinh có căn cứ · Nhóm VGO-E402 · Zone chưa có dữ liệu xác nhận
...
> hiện có. Workspace đã có **bản nháp** evidence log với phương pháp mining và
> 6 câu nguyên văn, nhưng chưa đạt chuẩn B vì mới có 6/20 mẫu và thiếu link/ngày.
> Tên willing users, feedback validation thật và kết quả chạy trọn golden set
> ≥20 case vẫn chưa có. Các chỗ đó được đánh dấu rõ; không dùng dữ liệu giả để
> lấp rubric.
...
Nguồn sơ bộ: [brief đề tài](docs/brief-de-tai.md),
[evidence log bản nháp](../local-draf/evidence-log.md) và bộ
[FAQ Facebook đã làm sạch](data/Data_FaceBook_ckean/ai_thuc_chien_facebook_feedback_clean.md).

- Evidence log bản nháp mô tả cách lấy câu hỏi gần nhất, tiêu chí loại mẫu và
  quy tắc gán đúng một chủ đề chính. Log hiện có **6 câu nguyên văn**: 3/6 về
  lịch và khả năng cân bằng, 1/6 về địa điểm, 1/6 về nội dung đánh giá năng lực,
  1/6 về khóa đang tuyển/trạng thái hồ sơ; 0/6 hỏi học phí.
- Bộ FAQ sạch tổng hợp 40 nhóm câu hỏi/phản hồi cộng đồng. File này đã gộp và
  ...
  văn** cho chuẩn evidence B. Các câu sinh từ file này chỉ là câu mô phỏng dùng
  để mở rộng kịch bản kiểm thử.
...
#### Sáu câu nguyên văn đang có trong evidence log

Các câu dưới đây giữ nguyên chính tả từ `local-draf/evidence-log.md`. Nguồn cấp
group đã biết, nhưng URL bài/bình luận và ngày đăng của từng câu vẫn chưa được
điền nên chưa đủ điều kiện tính là evidence B hoàn chỉnh.

| ID | Câu nguyên văn | Chủ đề chính |
|---|---|---|
| Q01 | “Mình mới biết đến cuộc thi này và xin có 1 thắc mắc ạ. Theo mình được biết thì lịch học khá dày, kéo dài gần như full-time (từ sáng đến chiều). Vậy các bạn thường sắp xếp việc học trên trường như thế nào khi tham gia ạ. Có phải xin nghỉ một thời gian, hay vẫn có thể cân bằng cả hai ạ.” | Lịch học/cân bằng |
| Q02 | “Cho em hỏi chương trình AI thực chiến này dự kiến có tổ chức dạy ở Hồ Chí Minh không ạ ? Do em muốn thi nhưng vì tổ chức dạy ở HN nên xa” | Địa điểm |
| Q03 | “Ai học xong khoá 1 rồi cho mình xin ít review lịch học và cách học với ạ,mk xin cảm ơn” | Lịch học/cách học |
| Q04 | “K rõ lịch học cụ thể thế nào” | Lịch học |
| Q05 | “Ac ơi cho em hỏi dgnl đầu vào là sẽ ktra những gì vậy ạ” | Nội dung ĐGNL |
| Q06 | “Cho em hỏi là giờ là tuyển sinh khóa 4 ạ?, trước đó em thấy là Khóa 5 mà ta, em có nộp CV từ hôm 18/7 đến giờ nhưng mà chưa có phản hồi gì, thì sau đó em thi vòng ĐGNL là khóa 5 đúng không ạ” | Khóa tuyển/trạng thái hồ sơ |

#### Câu mô phỏng sinh từ bộ Facebook clean

Các câu sau mô phỏng cách người dùng có thể hỏi dựa trên các chủ đề trong FAQ
clean. Chúng **không phải quote nguyên văn**, không có người nói thật để truy
vết và không được cộng vào cỡ mẫu evidence; chúng chỉ dùng cho thiết kế và
golden set.

| ID | Câu hỏi mô phỏng | Căn cứ để sinh |
|---|---|---|
| M01 | “Anh chị cho em xin kinh nghiệm để đậu vào chương trình của Vin với ạ, mình nên học trước phần nào ạ?” | FAQ §2–§3: người trái ngành, kiến thức nên chuẩn bị và bài ĐGNL |
| M02 | “Em trái ngành với mới biết Python cơ bản thì có theo được khóa không ạ, trước khi học em nên ôn gì?” | FAQ §2: nền tảng của người trái ngành |
| M03 | “Bài đánh giá đầu vào có những phần nào ạ, em nên ôn Python, SQL hay toán trước?” | FAQ §3: cấu trúc và nội dung ôn tập |
| M04 | “Em vẫn đang học ở trường thì có học song song được không ạ, lịch mỗi ngày thường từ mấy giờ đến mấy giờ?” | FAQ §6–§7: lịch hằng ngày và cam kết toàn thời gian |
| M05 | “Em ở TP.HCM thì khóa sắp tới có học trong này không hay phải ra Hà Nội ạ?” | FAQ §4: địa điểm học và kế hoạch TP.HCM chưa được xác nhận |
...
| T13 | “Anh chị cho em xin kinh nghiệm để đậu… nên học trước phần nào?” | ③ + mixed-scope | Tách hai ý: không dự đoán/cam kết cách “đậu”; chỉ nêu nội dung chuẩn bị có căn cứ và dẫn nguồn, phần kinh nghiệm cá nhân thì ghi là cộng đồng hoặc chuyển người | G1, G2, G10, G11 | Câu mô phỏng mới; chưa có test tự động |
...
| O04 | Anh chị cho em xin kinh nghiệm để đậu vào chương trình của Vin với ạ, mình nên học trước phần nào ạ? | ③ + mixed-scope | User cung cấp + FB clean §2–§3 | Không hứa cách “đậu”; trả phần chuẩn bị có nguồn và ghi rõ giới hạn |
...
**Khoảng trống:** 23 case trên mới là thiết kế trong spec, chưa có file
runner/result chạy trọn bộ. Sáu case có thể phát triển trực tiếp từ sáu câu
nguyên văn trong evidence log; các case sinh từ Facebook clean chỉ là mô phỏng.
Workspace không giữ raw chatlog tuyển sinh có metadata, nên **chưa đạt yêu cầu
...
| Golden set 23 case ở trên | Full web demo | **CHƯA CHẠY** | Chưa được phép kết luận | Cần tạo log trong `eval/` |
...
### Phân công tổng hợp từ artifact

| Thành viên | Mã HV | Vai trò đã ghi trong `Team.md` | Phần ghi trong Canvas CP1 | Deliverable dùng trong spec |
|---|---|---|---|---|
| Lương Thanh Trang | 2A202601363 | PM, UI, team lead | PM, spec, UI, demo | Spec, HAX/PAIR, UI, slide và demo |
| Nguyễn Thanh Hoàn | 2A202601201 | Tools | System prompt, build data | Prompt, tools và chuẩn hóa dữ liệu nguồn |
| Đỗ Đức Cường | 2A202601455 | Eval, tech lead | Evidence, golden set, evaluation | Evidence mining, golden set, chạy và báo cáo eval |
| Đỗ Tuấn Kiệt | 2A202601335 | Prompting Engineer | Tools, code, hỗ trợ build data | Prompting, code tích hợp RAG/app và dry run kỹ thuật |

`Team.md` và `local-draf/canvas-cp1.md` mô tả chéo phần prompt/tools của Hoàn và
Kiệt. Bảng trên giữ cả hai nguồn thay vì tự xóa một vai trò. Trước khi nộp, nhóm
cần chốt owner cuối cho từng deliverable và đồng bộ lại `Team.md`/`README.md`.
